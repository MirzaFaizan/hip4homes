...
function changeListItemValue(itemType) {
    var array = [14, 16, 18, 20, 22, 24, 26, 28, 30, 32, 34, 36, 38, 40, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60]
    ...
    if (itemType == 'Imperial Unit') {
        ...
        $("#width-greenhouse").html('');
        $.each(array, function (key, value) {
            $("#width-greenhouse").append(`<option value="${(0.3048 * value).toPrecision(3)}">${(value * 0.3048).toPrecision(3)}m</option>`);
        });
    }
}
